...
public static class DragDropAttachedProperties
{
    ...
    /// </summary>
    public static readonly DependencyProperty IsBeingDraggedProperty = DependencyProperty.RegisterAttached(
        "IsBeingDragged",
        typeof(bool),
        typeof(DragDropAttachedProperties)
    );
    ...
    /// </summary>
    public static readonly DependencyProperty IsDropAboveTargetProperty = DependencyProperty.RegisterAttached(
        "IsDropAboveTarget",
        typeof(bool),
        typeof(DragDropAttachedProperties)
    );
    ...
    /// </summary>
    public static readonly DependencyProperty IsDropBelowTargetProperty = DependencyProperty.RegisterAttached(
        "IsDropBelowTarget",
        typeof(bool),
        typeof(DragDropAttachedProperties)
    );
    ...
    /// </summary>
    public static readonly DependencyProperty IsDropOnTargetProperty = DependencyProperty.RegisterAttached(
        "IsDropOnTarget",
        typeof(bool),
        typeof(DragDropAttachedProperties)
    );
